...
const Blog = () => {
    return (
        <div className='px-96 my-24 text-start border border-blue-950 '>
            <h1 className='bg-slate-400'>Q-1 : When should we use Context API?</h1>
            ...
            <h1 className='bg-green-400 mt-5'>Q-2 : What is custom hook?</h1>
            ...
            <h1 className='bg-red-400 mt-5'>What is useRef()?When should we use this?</h1>
            ...
            <h1 className='bg-yellow-300 mt-5'>What is useMemo()?When should we use this?</h1>
            <p className='bg-yellow-300'>Ans: </p>
        </div>
    );
};
