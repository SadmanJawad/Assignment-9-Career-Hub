...
const Blog = () => {
    return (
        <div className='px-96 my-2 text-start'>
            ...
            <h1 className='bg-red-400 mt-5 text-xl font-semibold'>Q-3 :  What is useRef()?When should we use this?</h1>
            ...
            <h1 className='bg-yellow-300 mt-5 text-xl font-semibold'>Q-4 : What is useMemo()?When should we use this?</h1>
